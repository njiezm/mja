  ...
  <tr><td align="center">
    <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,.08)">
      ...
      <tr><td style="padding:36px 32px">
        <h1 style="margin:0 0 12px;font-size:22px;font-weight:800;color:#2048A4">Votre mot de passe a été réinitialisé</h1>
        <p style="margin:0 0 24px;color:#555;font-size:15px;line-height:1.7">
          Bonjour <strong>{{ $user->name }}</strong>,<br>
          le mot de passe de votre compte backoffice vient d'être réinitialisé par un administrateur.
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="background:#f0f5ff;border-radius:10px;margin-bottom:28px;overflow:hidden">
          ...
          <tr>
            ...
            <td style="padding:12px 20px;font-size:13px;color:#333">{{ $user->roleLabel() }}</td>
          </tr>
        </table>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="background:#fffbeb;border-left:4px solid #F5A623;border-radius:0 8px 8px 0;margin-bottom:28px">
          <tr><td style="padding:14px 18px">
            <p style="margin:0;font-size:13px;color:#92400e;line-height:1.6">
              <strong>Conseil sécurité :</strong> changez ce mot de passe dès votre prochaine connexion.
            </p>
          </td></tr>
        </table>
        ...
        <p style="font-size:13px;color:#999;margin:0">
          Vous n'êtes pas à l'origine de cette demande ? Prévenez immédiatement l'équipe.
        </p>
      </td></tr>
